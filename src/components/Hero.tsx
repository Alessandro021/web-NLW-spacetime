  ...
  return (
    <div className="space-y-5">
          ...
          <div className="max-w-[420px] space-y-1">
            ...
            <Link href="/memories/new" className="inline-block rounded-full bg-green-500 px-5 py-3 font-alt 
            text-sm uppercase leading-none text-black hover:bg-green-500">CADASTRAR LEMBRANÇA</Link>
        </div>
  )
}